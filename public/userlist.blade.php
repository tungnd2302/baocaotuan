	...
	<div class="col-md-12">
		<div class="widget box">
			<div class="widget-header">
				<h4><i class="icon-reorder"></i> Danh sách user  &nbsp;&nbsp;<a href="{{@Config::get('app.url'). '/ticket/public/admin/useradd'}}" class="bs-tooltip" title="Thêm"><i class="icon-plus-sign"></i></a></h4>
