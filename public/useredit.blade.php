...
<div class="tab-pane" id="tab_edit_account">
	<?php $url = 'http://' . getenv('HTTP_HOST') . '/ticket/public/admin/douseredit';?>
	<form class="form-horizontal" action="{{$url}}" method="post">
					...
					<div class="row">
						<div class="col-md-6">
								...
								<div class="col-md-8">
									<select class="form-control" name="department">
										@foreach ($departments as $department)
											<option value="{{$department->departmentid}}" <?php if($useredit->departmentid==$department->departmentid){echo 'selected="selected"';}?>>{{$department->departmentname}}</option>
										@endforeach				
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8"><input type="text" name="mobi" class="form-control" value="{{$useredit->mobi}}" ></div>
							</div>
		...
		<div class="col-md-12">
			<div class="widget">
				<div class="widget-header"><h4>Tạo yêu cầu hỗ trợ</h4></div>
				<div class="widget-content">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="col-md-4 control-label">Tự chọn cán bộ:</label>
								<div class="col-md-8">
									<select class="form-control" name="can_assign_technical">
										<option value="0" <?php if($useredit->can_assign_technical==0){echo 'selected="selected"';}?>>Không được phép</option>
										<option value="1" <?php if($useredit->can_assign_technical==1){echo 'selected="selected"';}?>>Được phép</option>
									</select>
								</div>
							</div>					
						</div>
